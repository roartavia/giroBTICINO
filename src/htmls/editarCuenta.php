    <?php
        ...
        $tiposCuentas = ['Canal'];
        $subtiposCuentas = ['Especificador e influenciador','Instalador','Inversionista','Usuario Final'];
    ?>
    <html>
        <body>
            <form method="post">
                ...
                <ul class='dropdown_list'>
                    ...
                    <li class='checkboxCompetencia hidden'><input type="checkbox" name="ckbx_Master" value="Master" <?php echo (isset($rows[0]->Master) && $rows[0]->Master==1  ? 'checked' : '');?>/>Master</li>
